...
b9="closed",a5="x",b8="ring_lookup",cr=",",J='"',a2="ring",k=246,b7=141,cq="(",a4="_vendor+v8.10+64bit/coq/plugins/setoid_ring/newring.ml",cp="constants",b6="preprocess tactic",aL="Field_tac",cc="with carrier ",co="postprocess tactic",aK="field",cn="InitialRing",cb="decidable",A="[",cf='and morphisms "',ck="Pphi_pow",cl='Using setoid "',cm="tactic recognizing constants",X=104,cj="postprocess",a_="gen_phiZ",aN="setoid",b5="and equivalence relation ",b4=")",aM=103,B="]",b2=":",b3="t",ca="preprocess",a3="power_tac",ci="Print",a9="power",b1="abstract",ch="Ring_polynom",aJ="sign",a8="protect_fv",b0="PEeval",a7="Ring",aI="div",b$='and "',a1="newring_plugin",cd="Add",ce="completeness",a0="IDphi",b_="morphism",cg="field_lookup",bZ="Pphi_dev",n=250,a6="Coq",H=jy.jsoo_runtime,E=H.caml_check_bound,c=H.caml_new_string,p=H.caml_obj_tag,aH=H.caml_register_global,z=H.caml_wrap_exception;function
...
gr=[0,0,0],gs=[0,0,0],gh=c("field kind"),gi=c(cm),gj=c(b6),gk=c(co),gl=c(aN),gm=c(a9),gn=c(aJ),go=c(aI),gp=c("infinite property"),f9=[0,c(aL),0],f_=[0,0,0],f$=c("field_lemmas"),ga=c("_field_lemma1"),gb=c("_field_lemma2"),gc=c("_field_lemma3"),gd=c("_field_lemma4"),ge=c("_lemma5"),gg=[22,0],gf=[22,0],f8=c("core.eq.congr"),f7=c("field inverse should be declared as a morphism"),fU=c("arguments of field_simplify do not have all the same type"),fV=[0,c(aK)],fT=[0,c(aL),0],fW=c(J),fX=c(J),fY=c("cannot find a declared field structure over"),fZ=[0,c(aK)],f0=[0,c(a4),816,12],fQ=c(b5),fR=c(cc),fP=c("The following field structures have been declared:"),fM=[0,1],fN=[0,0],fL=c("bad field structure"),eP=[0,0,0],eQ=[0,0,0],eG=c("ring kind"),eH=c(cm),eI=c(b6),eJ=c(co),eK=c(aN),eL=c(a9),eM=c(aJ),eN=c(aI),eF=c(" cannot be set twice"),ez=[0,c("Ring_base"),0],eA=c("ring_lemmas"),eB=c("_ring_lemma1"),eC=c("_ring_lemma2"),eE=[22,0],eD=[22,0],ex=[0,1],ey=[0,0],ew=c("bad ring structure"),ef=c("ring addition should be declared as a morphism"),eg=c("ring multiplication should be declared as a morphism"),eh=c("ring opposite should be declared as a morphism"),ei=c(J),ej=c(b$),ek=c(J),el=c(J),em=c('",'),en=c(cf),eo=c(J),ep=c(cl),eq=c(J),er=c(b$),es=c(J),et=c(cf),eu=c(J),ev=c(cl),eb=c("cannot find setoid relation"),d1=c("arguments of ring_simplify do not have all the same type"),d2=[0,c(a2)],d3=c(J),d4=c(J),d5=c("cannot find a declared ring structure over"),d6=[0,c(a2)],d7=[0,c(a4),360,12],dY=c(b5),dZ=c(cc),dX=c("The following ring structures have been declared:"),df=[0,c(ch),0],de=c("newring"),c$=c(a7),c_=c(a7),c6=c("ring: cannot find relation (not closed)"),c5=c("ring: cannot find relation"),cW=c(a5),cV=c(a5),cT=c(a5),cR=c("Ring.exec_tactic: anomaly"),cN=[2,1],cO=[0,1],cG=c(b3),cI=c(b3),cC=[0,c(a4),116,7],cz=c("not found"),cA=c("map "),cB=[0,c("lookup_map")],cv=c("dummy"),ct=c("global_head_of_constr."),cY=c("plugins.setoid_ring.Build_Setoid_Theory"),c0=c("core.option.None"),c1=c("core.option.Some"),c2=c("core.eq.type"),c3=c("core.list.cons"),c4=c("core.list.nil"),c7=c(a6),c8=[0,[0,c("Ring_theory"),0],[0,[0,c(ch),0],[0,[0,c("Ring_tac"),0],[0,[0,c(cn),0],[0,[0,c(aL),0],[0,[0,c("Field_theory"),0],0]]]]]],da=[0,c(a6),0],db=c(cn),dg=c("almost_ring_theory"),dh=c("Eqsth"),dj=c("Eq_ext"),dl=c("Eq_s_ext"),dn=c("ring_theory"),dp=c("mk_reqe"),dr=c("semi_ring_theory"),ds=c("mk_seqe"),du=c("Abstract"),dv=c("Computational"),dx=c("Morphism"),dz=c("inv_morph_nothing"),dA=c("mkhypo"),dC=c("hypo"),dF=c(b0),dI=c(ck),dL=c(bZ),dO=c(a_),dR=c(a0),dV=c(a2),dW=c("ring-tac-carrier-table"),d_=c("tactic-new-ring-theory"),eR=[0,c(a6),0],eS=c(aL),eX=c("FEeval"),e0=c(b0),e3=c(ck),e6=c(bZ),e9=c("display_pow_linear"),fa=c("display_linear"),fd=c(a_),fg=c(a0),fk=c(aK),fn=c("PCond"),fq=c(a_),ft=c(a0),fx=c("field_cond"),fy=c(aK),fA=c("simpl_field_expr"),fC=c("almost_field_theory"),fD=c("field_theory"),fE=c("semi_field_theory"),fF=c("AF_AR"),fH=c("F_R"),fJ=c("SF_SR"),fO=c("field-tac-carrier-table"),f3=c("tactic-new-field-theory"),iQ=c(ce),g8=[0,0],gE=c(b1),gF=c(cb),gG=c(b_),gH=c(B),gI=c(A),gJ=c(cp),gK=c(B),gL=c(A),gM=c(b9),gN=c(B),gO=c(A),gP=c(ca),gQ=c(B),gR=c(A),gS=c(cj),gT=c(aN),gU=c(B),gV=c(A),gW=c(a3),gX=c(B),gY=c(A),gZ=c(a3),g0=c(aJ),g1=c(aI),gw=c(a8),gz=c("in"),gB=c(a8),gD=c(a8),g5=c(cb),g9=c(b1),hb=c(b_),he=c(B),hh=c(A),hj=c(cp),hm=c(B),hp=c(A),hr=c(b9),hu=c(B),hx=c(A),hz=c(ca),hC=c(B),hF=c(A),hH=c(cj),hM=c(aN),hQ=c(aJ),hT=c(B),hW=c(A),hZ=c(a9),h2=c(B),h5=c(A),h8=c(a3),ia=c(aI),id=c("ring_mod"),ii=c(b4),ik=c(cr),im=c(cq),iq=c("ring_mods"),iu=[0,c(ci),[0,c("Rings"),0]],iz=c(b2),iB=c(a7),iC=c(cd),iG=c("AddSetoidRing"),iJ=c(B),iL=c(A),iN=c(b8),iP=c(b8),iV=c(ce),iY=c("field_mod"),i2=c(b4),i4=c(cr),i6=c(cq),i9=c("field_mods"),jb=[0,c(ci),[0,c("Fields"),0]],jg=c(b2),ji=c("Field"),jj=c(cd),jn=c("AddSetoidField"),jq=c(B),js=c(A),ju=c(cg),jw=c(cg);function
K(b){var
