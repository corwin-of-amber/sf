...
i8=115,ei=";",nD="ssr_wlog",ob="ambiguous: ",ji=",",ou="Variable ",nC="elim",aD="=",jh="The term ",i7="[=",U="(",jc="abstract constant ",jm=123,ot="not a term",os="ssrmmod",f2="last",or="!",aL="|",dr="//",nR="&",nS=677,jl="protect_term",oa="ssrautoprop",ds=173,ah="]",n$="=>",nQ=" already used",nB="%s%s%s",oq=122,nP="rewrite",du="suffices",op=145,nA="~",fQ="wlog",jb="exact",fW="_vendor+v8.10+64bit/coq/plugins/ssr/ssripats.ml",n_=768733515,nO="ipat@run: ",ja=248,n9="Prenex",i6="ssreflect_plugin",f0="^~",f1=">",n8="Hint",oo="by",n7="if",nN="200",ny="abstract_key",nz="ssrhyp",ch="->",y=246,fV=": ",n6="Only occurrences are allowed here",em="ssreflect",eq="_vendor+v8.10+64bit/coq/plugins/ssr/ssrcommon.ml",nx="generalized term didn't match",dt="apply",on="In",n5="View",cO="of",om="occ_switch expected",fP=121,el="under",ax="YouShouldNotTypeThis",ay="[",jk=108,ci=104,nM=3553392,ek="move",nw="_vendor+v8.10+64bit/coq/plugins/ssr/ssrbwd.ml",bP=103,L=120,n4=102,cM="<-",be="-",nL="{struct ",i$="K",nv=" := ",bO="Grammar placeholder match",jf=101,jg="[:",cL="/=",ol="99",nK="case",fS="ssrparser.mlg",ck="do",nu="@ can be used with let-ins only",n3="num.nat.S",dq=834253780,ep=100,bQ="*",i5="ssr_have",eo="3",ab="}",ok="Cannot apply lemma ",aw="in",je=936571788,oj="type",bt="@",n2="_%s_",fU=160,n1="Too many names in intro pattern",eh="suff",cg=157,nt="||",cI=852895407,fO="for",n0="ssripat",oi=126,an="{",fT="in ",oh="//=",av="",fR="^",nZ="Expected some implicits for ",i4="without",i3="ssr",nJ="Implicits",ns=", ",nX="suff: ssr cast hole deleted by typecheck",nY="Search",cN=135,ej="+",nI=" : ",cK="core.eq.type",og="-//",nH="num.nat.O",jj=571636041,fZ=" :=",of="_the_",nW=" in block intro pattern should be bound to an identifier.",I=141,nV="test_ssrslashnum01",fY=171,en=149,i_="pose",bs="?",nU=14611,dp="first",aX=" ",fX="_vendor+v8.10+64bit/coq/plugins/ssr/ssrfwd.ml",Y=")",oe="wlog: ssr cast hole deleted by typecheck",i9="let",Q=":",nT="Can't clear section hypothesis ",dn="|-",jd="loss",cf="abstract",cJ="-/",a5="_",J="/",nG="ssrclear",am=":=",nF="concl=",od=870530776,cj="have",oc="@ can be used with variables only",nE=250,X=amN.jsoo_runtime,nn=X.caml_bytes_get,eg=X.caml_bytes_set,N=X.caml_check_bound,aC=X.caml_equal,nr=X.caml_fresh_oo_id,np=X.caml_int_of_string,nq=X.caml_make_vect,bc=X.caml_ml_string_length,c=X.caml_new_string,no=X.caml_notequal,nm=X.caml_obj_tag,a4=X.caml_register_global,ce=X.caml_string_equal,at=X.caml_string_get,O=X.caml_string_notequal,G=X.caml_wrap_exception;function
...
o2=c(be),o3=c(f1),o4=c(a5),o5=c(bQ),o6=c(ej),o7=c(bs),o8=c(Y),o9=c(U),o_=c(Y),o$=c(U),pa=c(ah),pb=c(ay),pc=c(ah),pd=c(ay),pe=c(ah),pf=c(i7),pg=c(ah),ph=c(jg),pi=c(fR),pj=c(f0),pk=c(f0),pl=c("SSR: "),o1=c(J),oN=c(aD),oO=c(J),oM=c(cL),oQ=c(J),oR=c(J),oP=c(dr),oS=c(oh),oX=c(aD),oY=c(J),oZ=c(J),oV=c(aD),oW=c(dr),oT=c(cL),oU=c(J),oL=c(cM),oK=c(ch),oI=c(ab),oJ=c(an),oF=c(ab),oG=c("{-"),oD=c(ab),oE=c("{+"),oH=c("{}"),oA=c("$"),oy=c(Y),oz=c(U),ox=c(ns),ow=c(aL),ov=c(aX),pn=[0,c("Debug"),[0,c("Ssreflect"),0]],po=c("ssreflect debugging"),pu=c("Duplicate assumption "),pS=c(nH),pR=c(n3),qG=[12,0,0,0],qU=c("No product even after head-reduction."),rn=c("No assumption in "),ru=c("No applicable tactic."),rv=c("tclFIRSTi"),rB=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrcommon.ml", line 1515, characters 18-25')],rA=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrcommon.ml", line 1489, characters 43-50')],rz=c("top_assumption"),ry=c(cK),rx=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrcommon.ml", line 1449, characters 18-25')],rw=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrcommon.ml", line 1442, characters 22-29')],rt=c("rename_hd_prod: no head product"),rs=c(nQ),rp=[4,[0,1,1,1,1,0,0,0]],rq=[0,0],rl=[0,1],rk=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrcommon.ml", line 1324, characters 34-41')],rj=c("tclINTERP_AST_CLOSURE_TERM_AS_CONSTR: term with no ist"),ra=c(" contains holes and matches no subterm of the goal"),rb=[0,c(em)],rc=c(bt),re=[0,1],rd=[0,1],rf=c(bt),rg=c(aX),q$=c(jl),q9=c(jl),q8=c("pfLIFT"),q7=[0,0,[0,[0,0,0]]],q5=c("c@gentac="),q4=c("core.False.type"),q3=[0,1],q2=c(oc),q1=c(nu),qZ=c("occur_existential but no evars"),q0=c(nx),qX=c(fV),qY=c("At iteration "),qS=[0,0],qT=[0,1],qR=[0,c(eq),1010,17],qQ=[0,1],qO=[0,c(eq),948,18],qL=c("pf_interp_ty: ssr Type cast deleted by typecheck"),qM=[0,0],qK=[0,0],qJ=[0,0],qH=[12,0,0,0],qF=[15,[0,0]],qE=[15,1],qD=c("done"),qC=c(i3),qz=c("The ssreflect library was not loaded"),qA=c(" was not found"),qB=c("The tactic "),qx=[0,0],qv=c(" view "),qw=c("Cannot "),qt=c(U),qs=c("core.eq.refl"),qr=c(jl),qo=[0,[11,c("plugins.ssreflect."),[2,0,0]],c("plugins.ssreflect.%s")],qp=c(Y),qq=c("Small scale reflection library not loaded ("),qg=[0,0,0],qh=c("Should we tell the user?"),qe=[0,c(eq),573,37],qd=[0,0,0],qc=[0,0],qa=c("gentac creates no product"),p$=[0,0],p_=c(a5),p8=[0,[12,95,[2,0,[12,95,0]]],c(n2)],p9=c(a5),p7=[0,[2,0,[2,0,[12,95,0]]],c("%s%s_")],p5=[0,[2,0,[2,0,[2,0,0]]],c(nB)],p4=[0,[2,0,[4,0,0,0,[12,95,0]]],c("%s%d_")],p3=[0,[12,95,[2,0,[12,95,0]]],c(n2)],p1=[0,[2,0,[2,0,[2,0,0]]],c(nB)],pY=[0,c(eq),324,9],pX=c(nT),pW=[0,c(eq),270,12],pV=c("c@interp_refine="),pU=[0,1,1,0,1,0,0],pG=c("array_list_of_tl"),pF=c("array_app_tl"),pD=[0,c(em)],pB=[0,0,0,0],pv=c("No assumption is named "),pt=[0,c(nz)],ps=[0,c(em)],pH=[13,0,0,0],pJ=[12,[0,0]],pL=[12,1],pZ=c(of),p0=c("_tmp_"),ql=c(em),qy=c("top assumption"),qN=c("Ssreflect_plugin.Ssrcommon.NotEnoughProducts"),amJ=c('Could not fill dependent hole in "apply"'),ri=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrcommon.ml", line 1302, characters 31-38')],sc=c("..was NOT the last view"),sb=c("..was the last view"),sa=c("..a tactic"),r$=c("..a term"),r_=c("piling..."),sd=[0,c(n0)],se=c("tactic view not supported"),r8=c("view@finalized: "),r7=[0,c("_vendor+v8.10+64bit/coq/plugins/ssr/ssrview.ml"),297,57],r5=[0,0],r6=[0,0],r9=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrview.ml", line 290, characters 16-23')],r4=c(ot),r2=c("view"),r3=c("specialize"),r0=c("not an inductive"),r1=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrview.ml", line 233, characters 48-55')],rZ=c("tclADD_CLEAR_IF_ID: "),rW=c("interp-err: "),rX=c("interp-out: "),rV=c("interp-in: "),rY=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrview.ml", line 185, characters 43-50')],rR=c("ssr_inj_constr_in_glob"),rP=c(ot),rQ=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrview.ml", line 147, characters 19-26')],rO=c("vsASSERT_EMPTY: not empty"),rM=c("view_subject"),rC=c("view_adaptor_db"),rF=c("VIEW_ADAPTOR_DB"),rN=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssrview.ml", line 95, characters 34-41')],rT=[13,0,0,0],s7=[0,0],s6=c("can't decompose a quantified equality"),s5=c(cK),s1=c(av),s2=c("Not a projectable equality but a discriminable one."),s4=c("Nothing to inject."),s3=c(av),sW=[0,1],sV=[0,0],sT=c("elim called on a constr evar"),sU=c("Indeterminate pattern and no eliminator"),sA=c("adding inf pattern "),sz=c("Too many dependent abstractions"),sI=c("the defined ones matched"),sJ=c("Some patterns are undefined even after all"),sL=c("elim_pred_ty="),sK=c("elim_pred="),sG=c("postponing "),sH=[0,1],sD=c("doesn't"),sE=c("while the inferred pattern"),sF=c("The given pattern matches the term"),sC=c("inf. patterns="),sB=c("patterns="),sy=c("c_is_head_p= "),sw=c("Unable to apply the eliminator to the term"),su=c("elimty= "),st=c("elim= "),sS=c("Done Search "),sR=c(nY),ss=[0,0],sr=[0,1],sq=[0,1],sp=c("     got: "),sn=c("matching: "),so=[0,1],sl=c("==CASE=="),sm=c("==ELIM=="),sv=[0,c("_vendor+v8.10+64bit/coq/plugins/ssr/ssrelim.ml"),ja,11],sP=c("Simple elim with no term"),sM=c("occurs in the type of another non-instantiated pattern variable"),sN=c("was not completely instantiated and one of its variables"),sO=c("Pattern"),sk=[0,0],sj=c(cK),sf=c("type:"),sg=c("the eliminator's"),sh=c("A (applied) bound variable was expected as the conclusion of "),si=c("The eliminator has the wrong shape."),sX=c("rev concl"),sZ=c("injection equation"),tA=c(" is not unfoldable"),tB=c(jh),uC=c("locked"),uD=c("master_key"),uB=[1,[0,1,0]],ux=c("matches:"),uy=c("instance:"),ut=[0,0],uu=[0,0],uv=[0,1],uw=[0,1],uz=c("BEGIN INSTANCES"),uA=c("END INSTANCES"),ur=[0,0],us=[0,0],uq=[0,0],un=c(" of "),uo=c(" does not match "),up=c("pattern "),ui=c("rewrule="),ul=c("core.True.type"),uj=c("in rule "),uk=c("not a rewritable relation: "),uh=c("No occurrence of redex "),ud=c("RewriteRelation"),ue=c("Coq"),uf=c("Class_setoid"),t8=c("Type error was: "),t9=c("Rewriting impacts evars"),t_=c("Dependent type error in rewrite of "),t7=c("c_ty@rwcltac="),t5=c("r@rwcltac="),t6=c(cK),t$=c(" to "),ua=c("no cast from "),t1=[0,c("_vendor+v8.10+64bit/coq/plugins/ssr/ssrequality.ml"),382,17],tY=c("pirrel_rewrite of type: "),tX=c("pirrel_rewrite: proof term: "),t2=c("_r"),tZ=c("rewrite rule not an application"),t0=c("Rule's type:"),tQ=[0,0],tO=c("does not match redex "),tP=c("fold pattern "),tN=[0,0],tR=[0,1],tL=c(fT),tM=c("No occurrence of "),tK=c("unfoldintac"),tD=c(" even after unfolding"),tE=c(" contains no "),tF=c(jh),tG=c("does not unify with "),tH=c(jh),tJ=[0,1],tI=c("Failed to unfold "),ty=c("Custom simpl tactic does not support patterns"),tz=c("Custom simpl tactic does not support occurrence numbers"),ts=[0,0],tx=[0,0],tt=c("Improper rewrite clear switch"),tu=c("Right-to-left switch on simplification"),tv=c("Bad or useless multiplier"),tw=c("Missing redex for simplification occurrence"),tr=c("Conclusion is not an equality nor an arrow"),to=c(nF),tn=c("===newcongr==="),tp=c("ssr_congr_arrow"),tq=c(cK),tm=c("No congruence with "),tj=c(nF),ti=c("===congr==="),tk=c("-congruence with "),tl=c("No "),tg=c("rt="),te=c("===interp_congrarg_at==="),tf=c("nary_congruence"),td=c("simpl"),tb=[0,0,[0,1,[0,4,[0,[1,0],0]]]],s8=c("SSR:oldreworder"),s_=[0,c("SsrOldRewriteGoalsOrder"),0],s$=c("ssreflect 1.3 compatibility flag"),th=c("pattern value"),tS=c("rewrite rule"),tT=c("Ssreflect_plugin.Ssrequality.PRtype_error"),ub=[0,c("Classes"),[0,c("RelationClasses"),0]],uT=[0,1],uU=[0,0],uN=c(dt),uL=c(ok),uM=c("apply_rconstr without ist and not RVar"),uH=c(ok),uG=[0,0,0],uI=[0,c(nw),85,9],uE=[0,c(nw),31,9],uV=[0,0],vg=c(J),vf=c(J),uW=c(a5),uX=c(ej),uY=c(bQ),uZ=c(f1),u0=c(be),u1=c("\xc2\xbb"),u2=c("?\xc2\xab"),u3=c(bs),u4=c(ah),u5=c(aX),u6=c(jg),u7=c(ah),u8=c(i7),u9=c(Y),u_=c(U),u$=c(Y),va=c(U),vb=c(ah),vc=c(ay),vd=c(ah),ve=c(ay),vh=c(Y),vi=c("(try "),vj=c("E:"),vk=c(aL),ws=[1,0],wP=[0,c(fW),1008,14],wO=[0,c(fW),1001,14],wM=[1,[0,0]],wH=c(" has an unexpected shape. Did you tamper with it?"),wI=c(jc),wJ=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssripats.ml", line 954, characters 39-46')],wK=c(ny),wL=c(cf),wC=c("Did you tamper with it?"),wD=c(" not found in the evar map exactly once. "),wE=c(jc),wF=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssripats.ml", line 925, characters 18-25')],wG=c(cf),wx=c("not a proper abstract constant: "),wy=c(nQ),wz=c(jc),wA=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssripats.ml", line 907, characters 18-25')],wB=c(cf),wu=[0,0],wv=[0,0],wo=[0,0],wp=[0,1],wq=[0,0],wn=c("elim: only one elimination lemma can be provided"),wm=[0,c('File "_vendor+v8.10+64bit/coq/plugins/ssr/ssripats.ml", line 779, characters 20-27')],wh=[0,0],wl=[0,1],wk=c(oc),wj=c(nu),wi=c(nx),wd=c(i$),wb=c(cK),wc=[0,c(fW),nS,18],we=c(n1),v$=c(i$),wa=[0,c(i$)],wf=c(n1),wg=[0,0],v_=[0,0],v9=[0,0],v8=c(nO),v7=c(nO),v1=[0,0],v0=[0,0],v2=[0,c(fW),476,20],v3=[0,0],v4=[0,4],v6=c("tclCompileIPats output: "),v5=c("tclCompileIPats input: "),vW=c("Duplicate clear of "),vU=c("exec: "),vS=c(" goal:"),vT=c(" on state:"),vR=c("done: "),vP=c("abstract_lock"),vQ=c(cf),vN=c(nH),vO=c(n3),vJ=c(bs),vK=c(bs),vL=c(bs),vI=c("tac_intro_seed: no seed"),vH=[0,0],vG=c("seeding"),vv=[0,0,[0,[0,0,0]]],vq=c(" }}"),vr=c("name_seed: "),vs=c("to_generalize: "),vt=c("{{ to_clear: "),vp=c(ch),vn=c(be),vl=[0,0,0,0],vM=c("SSR:abstractid"),vX=c(i3),vY=c("duplicate-clear"),wV=[0,0],wW=c('tampering with discharged assumptions of "in" tactical'),wU=c("assumptions should be named explicitly"),wT=c("Duplicate generalization "),wR=c("Not enough subgoals"),wQ=c("Uninterpreted index"),wS=c("the_hidden_goal"),xC=c("ncons"),xW=c("under: to:"),xV=c("under: cannot pretty-rename bound variables with destApp"),xX=c("under: mapping:"),xU=c("under vars: "),xT=[0,0,0],x1=[0,0,0],x0=[0,0,0],x2=[0,0,0],xZ=[0,0,0],xY=[0,1],xO=c(")."),xP=c(", was given "),xQ=c(" tactic"),xR=c("(expected "),xS=c("Incorrect number of tactics"),xD=c("under: stop:"),xF=c("Under_eq"),xG=c("Under_eq_from_eq"),xI=c("Under_iff"),xJ=c("Under_iff_from_iff"),xH=c("core.iff.type"),xE=c(cK),xA=c("ssr_suff"),xz=c(nX),xB=c(nX),xn=c("SSR: wlog: var2rel: "),xo=c("SSR: wlog: pired: "),xt=c("specialized_ty="),xs=c("specialized="),xm=c(oe),xy=c(oe),xw=c(nD),xx=[0,c(fX),272,22],xp=c(nD),xq=c("gen have requires some generalizations"),xv=c("tmp"),xu=c(i5),xr=c(i5),xh=c(cf),xd=[0,c(fX),fY,14],xi=c(a5),xj=c("Given proof term is not of type "),xl=c("Suff have does not accept a proof term"),xe=c("not supported"),xf=c("arguments together with abstract variables is "),xg=c("Automatic generalization of unresolved implicit "),xk=[0,c(fX),201,23],w$=c("ssr_have_let"),xa=[0,0],xb=c(i5),w_=[1,0],xc=c(ny),w8=c("have: mixed C-G constr"),w9=c("have: mixed G-C constr"),w2=[0,1],wY=[0,1],wZ=c("Did you mean pose?"),w0=c("did not match and has holes."),w1=c("The pattern"),wX=[0,c(fX),35,14],w3=c("SSR:havenotcresolution"),w5=[0,c("SsrHave"),[0,c("NoTCResolution"),0]],w6=c("have type classes"),xM=c("over"),Ey=[0,c(fS),697,50],Ez=c("Can't delete section hypothesis "),HH=c(U),HI=c(Y),HJ=c(Q),HK=c(am),QZ=[0,0],agW=[0,[0,[1,1],0]],agX=[0,1],agT=c("under does not support multipliers"),agm=c(a5),agn=[0,c(ji),0],af9=c(ns),af_=c("_, "),afg=c(J),ae5=c(Q),aeR=c(Q),ad4=c("dependents switches '/' not allowed here"),adX=c(cf),acS=[0,91,[0,47,0]],acG=c(bO),aa5=c(ah),aa6=c(ay),aa1=[0,0],aaE=c(bO),aar=c(J),aap=c(J),$1=c("Dependent family abstractions not allowed in congr"),$X=[0,[0,0,0],0],$S=[0,[0,0,0],0],$A=c(aX),$B=c(aX),_Y=[0,0,0],_E=[0,[0,0,0],0],_y=[0,0,0],Zz=c("incompatible view and occurrence switch in dependent case tactic"),Y_=c("incompatible view and equation in move tactic"),Y9=c("incompatible view and occurrence switch in move tactic"),Y7=c("dependents switch `/' in move tactic"),Y8=c("no proper intro pattern for equation in move tactic"),YZ=[0,0,0],Yv=c(n6),Ys=c(n6),Yp=[1,2],Ym=[1,[0,0]],Yj=[1,0],X$=c(Q),Ya=[0,c(a5),[0,c(bs),[0,c(ch),[0,c(cM),0]]]],Yb=[0,c(Q),0],Yc=[0,c(Q),0],X6=c(bO),XV=c(aX),XE=[0,[0,0,0],0],Xo=[0,0,0],W7=c("multiple dependents switches '/'"),W6=c("missing gen list"),W2=c(J),W3=c(fV),W4=c(aX),W5=c(fV),WX=c("Clear flag {} not allowed here"),Wk=c("tclseq"),V$=c(bO),VZ=c("last "),V0=c(ei),VX=c("first "),VY=c(ei),VG=c("tcldo"),Vq=c(oa),Vp=c(oa),U_=c("tclintros"),U8=c(i3),U9=c(i6),UT=c(" is reserved."),UU=c("The identifier "),UV=c(" and ssreflect internal names."),UW=c("Conflict between "),UX=c("Scripts with explicit references to anonymous variables are fragile."),UY=c(" fits the _xxx_ format used for anonymous variables.\n"),UZ=c("The name "),Un=c('expected "last"'),Um=c('expected "first"'),Ul=[0,[22,0]],Uh=[0,c(dp),[0,c(f2),0]],Ui=[0,c(ay),0],Ub=c(bO),TY=c(aX),TV=c("|| "),TW=c(dp),TX=c(f2),TR=c(bO),Ti=[1,[0,0]],Tj=[0,[1,[0,0]],0],Th=c("ssrbinder is not a binder"),Te=[0,0],Tf=[0,1,[0,0,0]],Td=c("non-id accepted as binder"),S4=c(Q),SV=c(Q),R2=[0,[4,0],0],RN=c(" cofix "),RJ=c("Bad structural argument"),Rw=c('Missing identifier after "(co)fix"'),Rv=c(" fix "),Q0=c(ab),Q1=c(nL),QY=c("binder not a lambda nor a let in"),QP=[0,0],QQ=[0,1,[0,0,0]],QD=[0,1,[0,2,0]],Qr=[0,1,[0,2,0]],Qi=[0,0],P_=[0,0],P$=[0,1,[0,[0,1],0]],P3=[0,0],P4=[0,1,[0,0,0]],PZ=[0,0],P0=[0,1,[0,0,0]],Pa=c(fZ),Pb=c(Q),Pd=c("(* typeof *)"),Pc=c(fZ),O$=c(fZ),O_=[0,1,0],O9=[0,c(fS),1274,16],O8=[0,1,0],O4=c(fZ),O5=c(aX),OR=c(Y),OS=c(nI),OT=c(U),OU=c(Y),OV=c(nv),OW=c(nI),OX=c(U),OY=c(Y),OZ=c(nv),O0=c(U),O1=c(ab),O2=c(nL),O3=c(fV),OO=[0,0,0],OH=[0,0,7],OB=[0,0,6],Ot=[0,0,4],NY=c(fT),NC=c(" *"),ND=c(" |- *"),NE=c("|- *"),NF=c(" |-"),NG=c(bQ),NH=c("* |-"),Nr=c(bt),Ni=c(bt),Nc=c(U),M5=c(aX),M1=c(bt),MY=c(aX),MF=c(Y),MG=c(am),MH=c(U),Mt=c("by "),Lt=c(" ]"),Lu=c("[ "),Lp=[0,0,[0,0,0]],Lh=[0,0,0],K3=c("| "),K4=c(aL),K5=c(aL),KX=[0,c(Q),[0,c(am),[0,c(U),0]]],KR=c(bO),JY=c(n$),IL=c("binders XOR s-item allowed here: "),IK=c("Only binders allowed here: "),IM=c("No binder or s-item allowed here: "),II=[0,c(em)],IJ=c("No s-item allowed here: "),HD=c(ay),HE=c(Q),Hx=[0,0,[0,0,[0,0,0]]],FO=[0,0,0],FF=c("Only identifiers are allowed here"),FC=c(om),Fy=c(om),Ft=[0,[1,2],[0,[1,2],0]],Fp=[0,[1,2],0],Fl=[0,[1,[0,0]],0],Fg=[0,1,0],Fc=[0,[1,1],0],E_=[0,[1,0],0],EG=c(ck),EA=c(nW),EB=c(ou),EC=c(nW),ED=c(ou),Ex=[0,c(fS),nS,9],Eo=[0,c(fS),633,8],Ep=[1,[0,0]],Eq=[1,[0,0]],Er=[1,0],Es=c("TO DO"),DM=c(J),C6=c(U),C7=c(bt),C8=c(U),C1=c(U),C2=c(bt),B1=c(bs),B2=c(or),Bt=c(av),Bu=c(av),Bs=c("Index not a number"),Bq=c("Index not positive"),zB=c(J),zC=c(dr),zD=c(aD),zE=c(aD),zF=c(J),zG=c(aD),zH=c(aD),zI=c(aD),zJ=c(J),zK=c(cL),zL=c(aD),zy=c(be),yQ=c(nT),yO=c(aX),yN=c(a5),yx=c(bO),yf=c(bO),x5=c("SsrSyntax_is_Imported"),x4=c("SSR:loaded"),yg=c(ax),yi=c("ssrtacarg"),ym=c("5"),yy=c(ax),yA=c("ssrtac3arg"),yE=c(eo),yK=c("ssrtclarg"),yP=c("ssrhyprep"),y1=c(nz),y2=c("ssrhoirep"),zb=c("ssrhoi_hyp"),zm=c("ssrhoi_id"),zx=c("ssrhyps"),zz=c("ssrdir"),zA=c("ssrsimplrep"),zZ=c("test_not_ssrslashnum"),z0=c(nV),z2=c("test_ssrslashnum10"),z3=c("test_ssrslashnum11"),z5=c(nV),Af=c(oh),Ai=c(cL),Ak=c("ssrsimpl_ne"),Ao=[0,[0,c(aD)]],Ap=[0,[0,c(J)]],Aq=[0,[0,c(J)]],At=[0,[0,c(J)]],Au=[0,[0,c(J)]],Ax=[0,[0,c(aD)]],Ay=[0,[0,c(J)]],AB=[0,[0,c(cL)]],AC=[0,[0,c(J)]],AF=[0,[0,c(aD)]],AG=[0,[0,c(J)]],AH=[0,[0,c(J)]],AK=[0,[0,c(aD)]],AL=[0,[0,c(dr)]],AN=[0,[0,c(dr)]],A0=c("ssrsimpl"),A$=c(ab),Bb=c(an),Bd=c("ssrclear_ne"),Bp=c(nG),BE=c("ssrindex"),BU=c(be),BY=c(ej),B0=c("ssrocc"),B3=c(os),B5=c(os),B8=[0,0,[0,[0,c(or)]]],B_=[0,0,[0,0]],Ca=[0,0,[0,[0,c(bs)]]],Cq=c("ssrmult_ne"),CC=c("ssrmult"),CQ=c(ab),CS=c(an),CV=c(ab),CX=c(an),CZ=c("ssrdocc"),C3=c("ssrtermkind"),C9=c("term_annotation"),Dl=c(ax),Dn=c("ssrterm"),DA=c("ast_closure_term"),DK=c("ast_closure_lterm"),DX=c(ax),DZ=c("ssrbwdview"),D3=[0,[0,c(J)]],D6=[0,[0,c(J)]],Ef=c(ax),Eh=c("ssrfwdview"),Ek=[0,[0,c(J)]],Em=[0,[0,c(J)]],Et=c("ssripatrep"),EH=c("test_ident_no_do"),ET=c(ax),EV=c("ident_no_do"),EY=[0,[2,0]],E$=c(a5),Fd=c(bQ),Fh=c(f1),Fm=c(bs),Fq=c(ej),Fu=c("++"),Fz=c(ch),FD=c(cM),FI=c(ch),FL=c(cM),FP=c(be),FS=c(aD),FU=c(cJ),FX=c("-/="),F0=c(J),F2=c(cJ),F5=c(og),F8=c(J),F$=c(cJ),Gc=c(cL),Ge=c(cJ),Gh=c(aD),Gj=c(og),Gm=c("-//="),Gp=c(cL),Gs=c(cJ),Gv=c(aD),Gy=c(J),GB=c(cJ),GF=c(ah),GI=c(Q),GK=c(ay),GN=c(ah),GQ=c(jg),GS=c(n0),G4=c("ssripats"),Hd=c(aL),Hg=c(f1),Hi=c(dn),Hl=c(dn),Ho=c("|->"),Hr=c(nt),Hu=c("|||"),Hy=c("||||"),HB=c("ssriorpat"),HF=c("test_ssrhid"),HO=c("test_nobinder"),HZ=c(ax),H1=c("ssrcpat"),H3=c("hat"),H7=[0,0,[0,[0,c(fR)]]],H_=[0,[0,0,[0,[0,c(fR)]]],[0,[0,c(nA)]]],Ib=[0,[0,0,[0,[0,c(fR)]]],[0,[0,c(nA)]]],Ie=[0,0,[0,[0,c(f0)]]],Ih=[0,0,[0,[0,c(f0)]]],Ik=[0,[0,c(ah)]],Il=[0,[0,c(ay)]],In=[0,[0,c(ah)]],Io=[0,[0,c(ay)]],Iq=[0,[0,c(ah)]],Ir=[0,[0,c(i7)]],IG=c("ssripats_ne"),I3=c("ssrhpats"),Jm=c(bt),Jo=c("ssrhpats_wtransp"),JH=c("ssrhpats_nobs"),JS=c(ch),JV=c(cM),JX=c("ssrrpat"),J9=c(n$),J$=c("ssrintros_ne"),Kl=c("ssrintros"),Ky=c(ax),KA=c("ssrintrosarg"),KD=c(ax),KF=c("ssrtclintros"),KS=c(ax),KU=c("ssrfwdid"),KY=c("test_ssrfwdid"),Le=c(aL),Li=c(aL),Lm=c(aL),Lq=c(aL),Ls=c("ssrortacs"),LH=c(ah),LJ=c(ay),LM=c(ah),LO=c(ay),LR=c("ssrhintarg"),L5=c(ah),L7=c(ay),L_=c(ah),Ma=c(ay),Md=c("ssrhint3arg"),Mo=c(ah),Mq=c(ay),Ms=c("ssrortacarg"),ME=c("ssrhint"),M2=c(bt),M6=c(Y),M9=c(am),M$=c(U),Nd=c(Y),Nf=c(U),Nj=c(Y),Nm=c(am),No=c("(@"),Ns=c(Y),Nv=c(am),Nx=c(bt),Nz=c(U),NB=c("ssrwgen"),NI=c("ssrclseq"),NT=c(ji),NX=c("ssrclausehyps"),N$=c(bQ),Ob=c(dn),Od=c(aw),Og=c(dn),Oi=c(aw),Ol=c(bQ),On=c(aw),Oq=c(aw),Ou=c(bQ),Ow=c(dn),Oy=c(aw),OC=c(bQ),OE=c(aw),OI=c(dn),OK=c(bQ),OM=c(aw),OQ=c("ssrclauses"),O7=c("ssrfwdfmt"),Pr=c(am),Pu=c(am),Pw=c(Q),Py=c("ssrfwd"),PL=c(a5),PN=c("ssrbvar"),P5=c(Y),P7=c(U),Qa=c(Y),Qd=c(Q),Qf=c(U),Qj=c(Y),Qm=c(Q),Qo=c(U),Qs=c(Y),Qv=c(am),Qy=c(Q),QA=c(U),QE=c(Y),QH=c(am),QJ=c(U),QL=c("ssrbinder"),QR=c(ol),QU=[1,0,[0,[0,c(cO)]]],QW=[1,0,[0,[0,c(nR)]]],Ra=c(ab),Rd=c("struct"),Rf=c(an),Ri=c("ssrstruct"),Ru=c("ssrposefwd"),RK=c("fix"),RM=c("ssrfixfwd"),RY=c("cofix"),R0=c("ssrcofixfwd"),Si=c(ab),Sk=c(an),Sm=c(am),So=c(Q),Ss=c(am),Su=c(Q),Sy=c(ab),SA=c(an),SC=c(am),SG=c(am),SI=c("ssrsetfwd"),SW=c(Q),SZ=c(am),S1=c(Q),S5=c(am),S7=c(Q),S_=c(am),Ta=c("ssrhavefwd"),TA=c("ssrhavefwdwbinders"),TS=c(ax),TU=c("ssrdoarg"),Uc=c(ax),Ue=c("ssrseqarg"),Uf=[0,c(dp),[0,c("solve"),[0,c(ck),[0,c(nP),[0,c(cj),[0,c(du),[0,c(fQ),0]]]]]]],Uj=c("test_ssrseqvar"),Uo=c("ssrorelse"),Up=c("ssrseqidx"),Uq=c("ssrswap"),Uy=[0,0,[0,[2,[0,c(dp)]]]],UA=[0,0,[0,[2,[0,c(f2)]]]],UF=c("2"),UG=[0,0,[0,[0,c(nt)]]],UN=c(eo),UO=c("SSR:idents"),UQ=[0,c("SsrIdents"),0],UR=c("ssreflect identifiers"),U1=c("ssr_null"),U5=[0,0,[0,[2,0]]],U7=c("_perm_Hyp_"),Vb=[0,1],Vc=[0,[2,c("1")]],Ve=c("ssrparentacarg"),Vh=[0,[0,c(Y)]],Vi=[0,0,[0,[0,c(U)]]],Vm=[0,[2,c("0")]],Vt=c(oo),Vv=c("ssrtclby"),Vy=[0,0,[0,[0,c(oo)]]],VC=c(ck),VD=c(ax),VF=c("ssrtcldo"),VH=c("ssrdotac"),VK=c(eo),VP=[0,0,[0,[2,[0,c(ck)]]]],VR=[0,0,[0,[2,[0,c(ck)]]]],VU=[0,0,[0,[2,[0,c(ck)]]]],VV=[0,1],VW=[0,[2,c(eo)]],Wa=c(ax),Wc=c("ssrseqdir"),Wh=c(ax),Wj=c("ssrtclseq"),Wl=c("ssr_first"),Wm=c("ssr_first_else"),Wq=[0,[0,c(ah)]],Wr=[0,[0,c(aL)]],Ws=[0,0,[0,[0,c(ay)]]],WA=[0,[2,[0,c(dp)]]],WB=[0,[0,c(ei)]],WD=[0,[2,[0,c(dp)]]],WE=[0,[0,c(ei)]],WG=[0,[2,[0,c(f2)]]],WH=[0,[0,c(ei)]],WI=[0,2],WJ=[0,[2,c("4")]],W0=c("ssrgen"),Xj=c(ab),Xl=c(an),Xp=c(ab),Xr=c(an),Xv=c(ab),Xx=c(an),XA=c(J),XG=c("ssrdgens_tl"),XS=c(Q),XU=c("ssrdgens"),X7=c(ax),X9=c("ssreqid"),Yd=c("test_ssreqid"),Ye=c("ssreqpat"),Yk=[0,0,[0,[0,c(a5)]]],Yn=[0,0,[0,[0,c(bs)]]],Yq=[0,0,[0,[0,c(ej)]]],Yt=[0,[0,c(ch)]],Yw=[0,[0,c(cM)]],Yy=[0,0,[0,[0,c(ch)]]],YA=[0,0,[0,[0,c(cM)]]],Y1=c("ssrarg"),Y4=c("clear"),Y6=c(nG),Zj=c("ssrmovearg"),Zl=[0,c(ek),0],Zo=c(ek),Zs=c(ek),Zw=c(ek),Zy=c("ssrmove"),ZK=c("ssrcasearg"),ZM=[0,c(nK),0],ZQ=c(nK),ZS=c("ssrcase"),ZU=[0,c(nC),0],ZY=c(nC),Z0=c("ssrelim"),_b=c(ab),_d=c(an),_g=c("ssragen"),_t=c(ab),_v=c(an),_z=c(ab),_B=c(an),_G=c("ssragens"),_V=c(Q),_1=c(Q),_4=c("ssrapplyarg"),_6=[0,c(dt),0],_9=c(dt),_$=c("ssrapply"),$k=c(Q),$o=c("ssrexactarg"),$r=c("<:"),$s=c(jb),$u=[0,c(jb),0],$x=c(jb),$z=c("ssrexact"),$Y=c("ssrcongrarg"),$2=c("congr"),$4=c("ssrcongr"),aad=c(ab),aaf=c(an),aai=c(ab),aak=c(an),aan=c("ssrrwocc"),aaq=c("ssrrwkind"),aaF=c(ax),aaH=c("ssrrule_ne"),aaM=[1,0,[0,[0,c(J)]]],aa3=c("ssrrule"),abf=c(ah),abi=c(ay),abl=c("ssrpattern_squarep"),abw=c(ah),abz=c(ay),abB=c("ssrpattern_ne_squarep"),abU=c(be),abX=c(cJ),ab1=c(ab),ab3=c(an),ab6=c(ab),ab8=c(an),ab$=c(ab),acb=c(an),ace=c(ab),acg=c(an),ack=c("ssrrwarg"),aco=c("ssrinstancesofruleL2R"),acq=c("ssrinstofruleL2R"),act=c("ssrinstancesofruleR2L"),acv=c("ssrinstofruleR2L"),acH=c(ax),acJ=c("ssrrwargs"),acL=c("SSR:rewrite"),acN=[0,c("SsrRewrite"),0],acO=c("ssreflect rewrite"),acT=c("test_ssr_rw_syntax"),ac1=c(nP),ac3=c("ssrrewrite"),ade=c(ab),adg=c(an),adj=c("ssrunlockarg"),adv=c("ssrunlockargs"),adz=c("unlock"),adB=c("ssrunlock"),adF=c(i_),adI=c(i_),adL=c(i_),adN=c("ssrpose"),adS=c("set"),adU=c("ssrset"),adY=[0,0,[0,[2,[0,c(cf)]]]],adZ=[0,1],ad0=[0,[2,c(eo)]],ad5=c(cf),ad7=c("ssrabstract"),ad_=c(cj),aea=c("ssrhave"),aee=c(eh),aef=c(cj),aeh=c("ssrhavesuff"),ael=c(du),aem=c(cj),aeo=c("ssrhavesuffices"),aes=c(cj),aet=c(eh),aev=c("ssrsuffhave"),aez=c(cj),aeA=c(du),aeC=c("ssrsufficeshave"),aeS=c(Q),aeU=c("ssrsufffwd"),aeX=c(eh),aeZ=c("ssrsuff"),ae2=c(du),ae4=c("ssrsuffices"),afh=c(J),afj=c(Q),afl=c("ssrwlogfwd"),afq=c(fQ),afs=c("ssrwlog"),afx=c(eh),afy=c(fQ),afA=c("ssrwlogs"),afF=c(du),afG=c(fQ),afI=c("ssrwlogss"),afN=c(jd),afO=c(i4),afQ=c("ssrwithoutloss"),afV=c(eh),afW=c(jd),afX=c(i4),afZ=c("ssrwithoutlosss"),af4=c(du),af5=c(jd),af6=c(i4),af8=c("ssrwithoutlossss"),agj=c("ssr_idcomma"),ago=c("test_idcomma"),agt=[0,[0,c(ji)]],agv=[1,0,[0,[2,0]]],agx=[1,0,[0,[0,c(a5)]]],agF=c(cj),agG=c("gen"),agI=c("ssrgenhave"),agP=c(cj),agQ=c("generally"),agS=c("ssrgenhave2"),agY=c(ck),ag0=c(el),ag3=c(ck),ag6=c(el),ag_=c(el),ahb=c(el),ahd=c(el),aj4=c("no head constant in head search pattern"),al6=[0,0,[0,1,[0,2,0]]],al2=c(aX),al3=c("Hint View"),alL=[0,2],alB=[0,2],alt=[0,1],all=[0,0],ak$=c(" for move/"),ala=c(" for apply/"),alb=c(" for apply//"),akT=c(aL),akR=c(aL),akS=c(aL),akH=c(Q),akF=c("No Module "),akf=c(av),akg=c(fT),akd=c(be),aj$=c("to interpret head search pattern as type"),aka=c("need explicit coercion "),aj_=c("Listing only lemmas with conclusion matching "),aj7=[11,0],aj9=c("too many arguments in head search pattern"),ajJ=c(be),ajK=c(av),ai1=c('"'),ai2=c("Lonely notation"),ai3=c("Scope "),ai4=c(av),ai5=c(av),ai6=c(av),ai7=c(av),aiZ=c(av),ai0=c(av),aiT=c(av),aiV=c(av),aiU=c(fT),aiR=c(av),aiS=c("independently"),aiQ=c("and "),aiO=c(Y),aiP=c(U),aiN=[0,c("interp_search_notation")],aiW=c("empty notation fragment"),aiX=c(av),aiY=c(av),ai8=c("also occurs in "),ai9=c(on),ajk=c("occurs in"),ajl=c(aw),ajm=c(ob),ajn=c("is part of notation "),ajo=c(on),ajp=c("does not occur in any notation"),ajq=c(aw),ajj=[0,0,0],ai_=c("is defined "),ai$=c(aw),aja=c(ob),ajb=c(av),aji=c("In "),ajd=c("denotes "),aje=c(" is also defined "),ajg=c(" .. "),ajh=c(" is an n-ary notation"),aiM=c("H"),aiG=[59,0,[0,c("Printing"),[0,c("Implicit"),[0,c("Defensive"),0]]],0],aip=c("Expected prenex implicits for "),aio=c(" is not declared"),aiq=c("Multiple implicits not supported"),ais=c(nZ),air=c(nZ),aif=[0,0],ahH=[2,0],ahe=c(i6),ahg=c("ssr_rtype"),ahh=c("ssr_mpat"),ahi=c("ssr_dpat"),ahj=c("ssr_dthen"),ahk=c("ssr_elsepat"),ahl=c("ssr_else"),ahp=c("100"),ahq=[0,0,[0,[0,c("return")]]],ahx=[0,[0,c(aw)]],ahE=[0,[0,c("then")]],ahI=[0,0,[0,[0,c("else")]]],ahQ=[0,[0,c("is")]],ahR=c(nN),ahS=[0,0,[0,[0,c(n7)]]],ahV=[0,[0,c("isn't")]],ahW=c(nN),ahX=[0,0,[0,[0,c(n7)]]],ah0=[0,[0,c(aw)]],ah1=[0,[0,c(am)]],ah2=[0,[0,0,[0,[0,c(i9)]]],[0,[0,c(Q)]]],ah5=[0,[0,c(aw)]],ah6=[0,[0,c(am)]],ah7=[0,[0,0,[0,[0,c(i9)]]],[0,[0,c(Q)]]],ah_=[0,[0,c(aw)]],ah$=[0,[0,c(am)]],aia=[0,[0,c(aw)]],aib=[0,[0,0,[0,[0,c(i9)]]],[0,[0,c(Q)]]],aig=c(ol),aij=[1,0,[0,[0,c(cO)]]],ail=[1,0,[0,[0,c(nR)]]],aiy=c(nJ),aiz=c(n9),aiD=c("Ssrpreneximplicits"),aiH=[0,[0,[0,0,[0,[2,[0,c("Import")]]]],[0,[2,[0,c(n9)]]]],[0,[2,[0,c(nJ)]]]],aiK=c("ssr_searchitem"),ajE=c("%"),ajI=c("ssr_search_item"),ajX=c(be),aj1=c("ssr_search_arg"),ake=c("ssrmodloc"),akr=c("ssr_modlocs"),aku=c("modloc"),aky=[0,0,[0,[0,c(be)]]],akD=[0,0,[0,[0,c(aw)]]],akM=c(nY),akQ=c("SsrSearchPattern"),ak7=c(aL),ak9=c("ssrhintref"),alm=c(J),alo=c(ek),alq=c(fO),alu=c(J),alw=c(dt),aly=c(fO),alC=c(J),alE=c(J),alG=c(dt),alI=c(fO),alM=c(dr),alO=c(dt),alQ=c(fO),alT=c("ssrviewpos"),al0=c("ssrviewposspc"),al8=c(n5),al9=c(n8),al_=c("Print"),amc=c("PrintView"),amh=c(n5),ami=c(n8),amm=c("HintView"),amq=[0,[0,c(Y)]],amr=[0,[0,[0,0,[0,[0,c(U)]]],[0,[2,[0,c(oj)]]]],[0,[0,c(cO)]]],amu=[0,[0,c(Y)]],amv=[0,[0,[0,0,[0,[0,c(U)]]],[0,[2,[0,c("value")]]]],[0,[0,c(cO)]]],amz=[0,[0,c(Y)]],amA=[0,[0,[0,[0,0,[0,[0,c(aw)]]],[0,[0,c(U)]]],[0,[0,c("Type")]]],[0,[0,c(cO)]]],amD=[0,[0,c(Y)]],amE=[0,[0,[0,[0,0,[0,[0,c(aw)]]],[0,[0,c(U)]]],[0,[2,[0,c("Value")]]]],[0,[0,c(cO)]]],amI=[0,[0,0,[0,[2,[0,c(oj)]]]],[0,[0,c(cO)]]];function
...
jt(c){var
e=nm(c),f=nE===e?c[1]:y===e?a(ju[2],c):c,g=a(d[3],pl),h=b(d[12],g,f);return b(aJ[9],0,h)}function
...
gs(o,s,n){var
e=n[1],j=f(g[5],qc,e,n[2]),p=a(x[en],e),t=a(q[2],o),u=jR(a(q[3],o));function
k(d,l){var
...
bA(c,b){return az(a(x[en],c),b)}function
dL(f,e){var
d=e;for(;;){var
...
dM(e,c){var
f=a(q[1],c),h=a(q[3],c),i=a(q[2],c),d=af(x[fY],0,0,0,h,i,e),k=d[2],l=b(j[3],f,d[1]);return[0,a(g[I][1],k),l]}function
gx(e,d,c){var
...
cr(h,j,e,c,d){var
k=h?h[1]:0,l=e?e[1]:1,m=a(x[en],c[1]),n=f(g[5],qS,c[1],c[2]),i=jU(d,[0,c[1],n]),o=i[2],q=i[1],r=b(p[28],m,d);try{var
...
j9(b){try{var
c=a(j[4],b),k=a(q[2],b),l=f(g[ep],k,1,c)[1],m=qV(a(h[17][5],l),b);return m}catch(c){c=G(c);try{var
...
kr(c,d){var
f=F[fU][2],g=c?gP([0,c[1]]):a(e[16],0),h=a(F[148],[0,d,0]),i=b(e[73][2],h,g);return b(e[73][2],i,f)}function
...
c=a(g[9],b),d=d9[6],e=a(j[2],m);return f(g[ep],e,d,c)[2]},ch=b(h[19][15],eb,ea);else
var
...
d=a(j[2],l),e=a(x[en],d),f=b(x[cg],c[2],e),g=[0,c[1],f];return a(dP(dF,[0,b0,0]),g)},dQ=K?1:0,dR=[0,a9,[0,aV,S,a(g[10],bW+dQ|0)]],b1=gx(dL,a(g[23],dR),l),dS=b1[2],dT=b1[1],dU=b(g[L][1],1,bH),dV=f(g[35],dT,0,dU),dW=0===A?0:bB,bL=dV,bK=dN,bJ=dW,aO=dS,am=1,an=0;else
var
an=1;if(an)var
am=0}else
var
...
x=ky(c);function
i(c){var
d=ky(c)-x|0,k=a(j[4],c),l=a(j[2],c),e=f(g[ep],l,d,k),i=e[1],m=e[2],n=a(h[17][9],i),o=b(g[44],m,n),p=[0,[0,b(E[4],[0,sY],0),o],0],r=b(h[18],i,p),s=gy(a(g[10],d+1|0),-d|0,1),t=b(g[45],s,r),u=[0,t,[0,a(Z[2],0)]],v=a(g[23],u),w=a(g[I][1],v);return f(q[5],1,w,c)}var
k=1,l=0;function
...
kO(n,B,m){var
i=a(j[5],m),c=nm(e4),s=nE===c?e4[1]:y===c?a(ju[2],e4):e4,ag=uc(i)?function(d,c,b){var
...
b=af(x[fY],0,0,0,i,c,s[1]),h=b[1];return[0,a(g[23],[0,b[2],e]),h]}var
d=af(x[fY],0,0,0,i,c,s[2]),j=d[1];return[0,a(g[23],[0,d[2],e]),j]}}}(k,e),aC=a(ai[2],ul),aD=a(gH[23],aC),aE=a(g[9],aD),aF=N(e,0)[1];if(f(g[bP],c,aF,aE)){var
...
y=b(P[23],h,s),z=[0,t,[0,h,a(x[en],h),y]];return z}throw p[3]}catch(a){var
e=o;continue}}var
...
h=H(e[31],0,1,3,e[41]),i=b(F[fU][1],0,f);return b(e[73][2],i,h)}var
...
var
ba=hp(i,K,function(a,b){return j5(n,a,b)},jF),as=ah(c,0,hp(D,ba,function(a,b){return eP(n,a,b)},eB)),at=as[2],au=aG(az(as[3],c),at),av=au[2],aw=au[1],bb=a(j[2],aw),bc=f(g[ep],bb,1,av)[1],bd=function(c){try{var
...
t=function(f){var
c=bk(xI,i,f),j=c[2],d=bk(xJ,i,c[1]),l=d[2],m=d[1],n=a(g[23],[0,j,k]),e=bd(Z[4],0,0,0,0,0,0,0,0,i,m,n),o=e[1],p=[0,l,b(h[19][5],k,[0,e[2]])];return[0,o,a(g[23],p)]};return b(F[fU][1],1,t)}}var
p=f(P[29],i,c,o),n=b(g[7],c,p);if(4===n[0]){var
j=n[2],q=n[1];if(eW(c,q,a(ai[2],xE)))if(3===j.length-1)if(lo(c,N(j,2)[3])){var
r=function(f){var
c=bk(xF,i,f),k=c[2],d=bk(xG,i,c[1]),l=d[2],m=d[1],n=a(g[23],[0,k,j]),e=bd(Z[4],0,0,0,0,0,0,0,0,i,m,n),o=e[1],p=[0,l,b(h[19][5],j,[0,e[2]])];return[0,o,a(g[23],p)]};return b(F[fU][1],1,r)}}z([y,function(h){var
...
agz=0;function
agA(h,g,f,d,c,a){var
i=m5(h,f),j=[0,nM,g],k=0;function
