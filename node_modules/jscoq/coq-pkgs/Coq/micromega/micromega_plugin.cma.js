...
ni="QMicromega",nF="*",i$="param.csdp",nA="__varmap",nE="diagonalize: not PSD",nc="csdp: error ",n2="monoid",n9="__p",nQ="__p%i",nR=",",ji='"',n8=" 1 ",nP="1\n",n7="__ff",nh="=",nz="find_pivot",nO="%s*%a",n1="Require Import ZArith Lia. Open Scope Z_scope.\n",i6='"\n',no="buggy certificate",nD="lia",ao="ZMicromega",nN=" * ",M="micromega",g2='command "',ny=")^2",nb="compare_num",jl="real_nonlinear_prover",ng=" [*] ",nM="__wit",n0=143,nf="Zero",jk="Lia",i_="; csdp ",nn="ERROR: no compatible proof",aP="",cr="RingMicromega",nL='Unfortunately Coq isn\'t aware of the presence of any "csdp" executable in the path. \n\n',jg="real nonlinear prover",jf="0",je="> /dev/null",nx="%a * %a",na="__arith",eo="Reals",n6=", False\n",i9=438,aX=248,m_="<=",m$="QArith",jd="cd ",nC=") * (",dk=" + ",A="Coq",nZ="psatz_R",ne=148,nY=".",nl="Csdp packages are provided by some OS distributions; binaries and source code can be downloaded from https://projects.coin-or.org/Csdp",nm=" : ",nX="Bad logical fragment",e=246,nk="-%a",nB="(%a) * (%a)",n5="x%i",nK=118,ac="Tauto",jc="%a + %a",nJ=119,jh=" Cannot find witness",nI="csdp: Problem is infeasible",nW="Z",nw="the use of a specialized external tool called csdp. \n\n",av=" ",n4="e",an=103,g1=120,nV="EnvRing",m9="t",nd="PsatzZ",i8=".dat-s",nv="-",jj="_vendor+v8.10+64bit/coq/plugins/micromega/mfourier.ml",n3="Rdefinitions",nu="Timeout",nH="D",nT="linear prover",nU="Depth",nj="(%a)^2",nG=" Skipping what remains of this tactic: the complexity of the goal requires ",ns="psatz_Q",nt='" exited ',g4="_vendor+v8.10+64bit/coq/plugins/micromega/certificate.ml",g3="%s",nq="psatz_Z",jb=".out",nr="Rpow_def",np="nat",m8="%i",ja="sos",i7="pure_sos",aO="\n",nS=0.693147180559945286,aF="VarMap",k=250,E=Ix.jsoo_runtime,K=E.caml_check_bound,gY=E.caml_compare,_=E.caml_equal,aW=E.caml_fresh_oo_id,bk=E.caml_int_compare,m6=E.caml_int_of_string,cq=E.caml_lessthan,Iu=E.caml_list_of_js_array,cQ=E.caml_ml_string_length,gZ=E.caml_mul,c=E.caml_new_string,j=E.caml_obj_tag,aE=E.caml_register_global,m5=E.caml_string_equal,b0=E.caml_string_get,dj=E.caml_sys_remove,i5=E.caml_sys_system_command,q=E.caml_wrap_exception;function
...
d(i){var
e=h(R[23],i,zz,i9),j=b(R[30],e),d=b(c[1],100);function
n(e){for(;;){var
a=s(j);if(a){var
b=a[1];h(c[10],d,b[1],b[2]);continue}return 0}}try{g(0,e,n);b(f[83],j);var
o=h(R[23],i,zC,i9),p=[0,b(R[31],o),1,d];return p}catch(e){e=q(e);if(e===l){b(f[83],j);var
m=h(R[23],i,zA,i9),k=b(R[31],m);g(1,m,function(g){function
