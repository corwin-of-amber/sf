...
kz=" :: ",bJ="module ",eq=";",c_="_vendor+v8.10+64bit/coq/plugins/extraction/table.ml",lh="i",cg=",",kK="functor (",k7="expr:lambda",kx="JSON",gA="=",ky=".\n",ez="(",k6=") ->",kJ="Haskell",kI='Prelude.error "EXTRACTION OF UINT NOT IMPLEMENTED"',k5="Compilation of file ",ak="_vendor+v8.10+64bit/coq/plugins/extraction/common.ml",et="]",kH=309,gO="=>",gN="(* ",k4="Cannot mix yet user-given match and general patterns.",gH=495,k3="Print",gW="#else",eF=" ->",c9="_vendor+v8.10+64bit/coq/plugins/extraction/modutil.ml",bo=248,k2="Coq.Init.Specif",k1="match ",a2="_vendor+v8.10+64bit/coq/plugins/extraction/mlutil.ml",gV="| ",kG="Constant",kE="items",kF="_vendor+v8.10+64bit/coq/plugins/extraction/json.ml",k0="if",kw="define ",N="_vendor+v8.10+64bit/coq/plugins/extraction/extraction.ml",kv="->",kZ=": ",eE="UNUSED",lg="error",ap=" = ",lf="of",c7=121,ey="[",gM="'",kY="Close it and try again.",eD=108,C="Extraction",kD="unsafeCoerce :: a -> b",bn="extraction",X="name",ep=103,au=120,kX=" : logical inductive",U="__",kW=272,gL=102,ku="unit",gG="args",le=" (* AXIOM TO BE REALIZED *)",gU="-- HUGS",kt=132,da="body",kC="case",a3="  ",lc="Any",ld="do",ks="struct",c6="end",gF="#endif",kV="Reset",gE=" *)",ex="module type ",bl="_vendor+v8.10+64bit/coq/plugins/extraction/extract_env.ml",kU="else",db="}",es="in",eC="type",gz="Coq_",bq=107,gT="module",la=" }",lb="force",kT="match",gS=143,gK="#ifdef __GLASGOW_HASKELL__",c5="argnames",u="what",kr="for",c$=109,gR=126,er="_vendor+v8.10+64bit/coq/plugins/extraction/haskell.ml",gJ="in ",bm="type ",aj="",k$="then",kB="Obj.magic",gQ="let ",eo="and ",ai=" =",gD="Inline",kS="OCaml",en="sig",ew="_vendor+v8.10+64bit/coq/plugins/extraction/scheme.ml",k_=" end",kR="with constructors : ",av=".",eB=" :",gP=".ml",kQ="unsafeCoerce",kq="class",kA=523,kP="Recursive",gC="Blacklist",gI="Extract",k9="Scheme",ev="false",kp="let {",ko="Library",kO=106,W=" ",c4="_vendor+v8.10+64bit/coq/plugins/extraction/ocaml.ml",c8=")",gB="let",kn=" with",kN=":",kM="let rec ",eA="value",bp="_",kL="as",k8="singleton inductive, whose constructor was ",eu="true",E=DN.jsoo_runtime,i=E.caml_check_bound,bk=E.caml_fresh_oo_id,kl=E.caml_int_compare,c3=E.caml_list_of_js_array,bI=E.caml_make_vect,cf=E.caml_ml_string_length,d=E.caml_new_string,ah=E.caml_register_global,aa=E.caml_string_get,ao=E.caml_string_notequal,DM=E.caml_trampoline,gx=E.caml_trampoline_return,km=E.caml_update_dummy,l=E.caml_wrap_exception;function
...
lj=d("get_nth_label: not enough MPdot"),ol=[0,d(c_),764,11],oc=d(" is not a valid argument number for "),od=d(" for "),oe=d("No argument "),n4=d(a3),n2=d(a3),n3=d("Extraction NoInline:"),n5=d("Extraction Inline:"),ns=d(C),nt=d("Extraction "),nq=d(" has been created by extraction."),nr=d("The file "),no=d(" first."),np=d("Please load library "),nh=d("but this code is potentially unsafe, please review it manually."),ni=d("Extraction SafeImplicits is unset, extracting nonetheless,"),nj=d(av),nk=d("At least an implicit occurs after extraction : "),nb=d("the extraction of unsafe code and review it manually."),nc=d("You might also try Unset Extraction SafeImplicits to force"),nd=d("Please check your Extraction Implicit declarations."),ne=d(av),nf=d("An implicit occurs after extraction : "),m7=d(aj),m8=d(") "),m9=d(ez),na=d(aj),m_=d("of "),m$=d(" argument "),mX=d("asked"),m6=d("required"),mY=d("extract some objects of this module or\n"),m5=d(aj),mZ=d("use (Recursive) Extraction Library instead.\n"),m0=d("Please "),m1=d("Monolithic Extraction cannot deal with this situation.\n"),m2=d(ky),m3=d(".v as a module is "),m4=d("Extraction of file "),mU=d("Use Recursive Extraction to get the whole environment."),mV=d("For example, it may be inside an applied functor.\n"),mW=d(" is not directly visible.\n"),mT=d("No Scheme modular extraction available yet."),mR=d("not found."),mS=d("Module"),mH=d(" (or in its mutual block)"),mI=d(gJ),mJ=d("or extract to Haskell."),mK=d("Instead, use a sort-monomorphic type such as (True /\\ True)\n"),mL=d("The Ocaml extraction cannot handle this situation yet.\n"),mM=d("has logical parameters, such as (I,I) : (True * True) : Prop.\n"),mN=d("This happens when a sort-polymorphic singleton inductive type\n"),mO=d(av),mP=d(" has a Prop instance"),mQ=d("The informative inductive type "),mD=d("This situation is currently unsupported by the extraction."),mE=d("some Declare Module outside any Module Type.\n"),mF=d(" has no body, it probably comes from\n"),mG=d("The module "),mz=d("This is not supported yet. Please do some renaming first."),mA=d(" have the same ML name.\n"),mB=d(" and "),mC=d("The Coq modules "),my=d("Not the right number of constructors."),mx=d("is not an inductive type."),mw=d(" is not a constant."),mr=d(" contains __ which is reserved for the extraction"),ms=d("The identifier "),mo=d(kY),mp=d("You can't do that within a section."),mm=d(kY),mn=d("You can't do that within a Module Type."),mh=d("In case of problem, close it first."),mi=d("Extraction inside an opened module is experimental."),md=d(" type variable(s)."),me=d("needs "),mf=d("The type scheme axiom "),l6=d("fully qualified name."),l7=d("First choice is assumed, for the second one please use "),l8=d(" ?"),l9=d(" or object "),l_=d("do you mean module "),l$=d(" is ambiguous, "),ma=d("The name "),lY=d('If necessary, use "Set Extraction AccessOpaque" to change this.'),lZ=d(av),l0=d("the following opaque constants have been extracted as axioms :"),l1=d("The extraction now honors the opacity constraints by default, "),lR=d(av),lS=d("the following opaque constant bodies have been accessed :"),lT=d("The extraction is currently set to bypass opacity, "),lG=d("axiom was"),lM=d("axioms were"),lH=d("may lead to incorrect or non-terminating ML terms."),lI=d("Having invalid logical axiom in the environment when extracting"),lJ=d(ky),lK=d(" encountered:"),lL=d("The following logical "),lx=d("axiom"),lB=d("axioms"),ly=d(av),lz=d(" must be realized in the extracted code:"),lA=d("The following "),lv=[0,d(C)],lu=d(av),lr=[0,d(c_),292,11],ls=d(av),lq=d("Inductive object unknown to extraction and not globally visible."),lm=d("_rec"),ln=d("_rect"),ll=[0,d(c_),170,11],lk=[0,d(c_),157,11],li=[0,d(c_),60,9],lC=d(bn),lD=d("extraction-axiom-to-realize"),lN=d(bn),lO=d("extraction-logical-axiom"),lU=d(bn),lV=d("extraction-opaque-accessed"),l2=d(bn),l3=d("extraction-opaque-as-axiom"),mb=d(bn),mc=d("extraction-ambiguous-name"),mj=d(bn),mk=d("extraction-inside-module"),mt=d(bn),mu=d("extraction-reserved-identifier"),nl=d(bn),nm=d("extraction-remaining-implicit"),nu=d("AccessOpaque"),nv=d("AutoInline"),nw=d("TypeExpand"),nx=d("KeepSingleton"),nA=[0,d(C),[0,d("Optimize"),0]],nB=d("Extraction Optimize"),nE=[0,d(C),[0,d("Flag"),0]],nF=d("Extraction Flag"),nI=[0,d(C),[0,d("Conservative"),[0,d("Types"),0]]],nJ=d("Extraction Conservative Types"),nL=d(aj),nN=[0,d(C),[0,d("File"),[0,d("Comment"),0]]],nO=d("Extraction File Comment"),nQ=d("ExtrLang"),nT=d("Extraction Lang"),nW=d("ExtrInline"),n0=d("Extraction Inline"),n8=d("Reset Extraction Inline"),n$=d("SafeImplicits"),ob=d("ExtrImplicit"),oh=d("Extraction Implicit"),ok=d("ExtrBlacklist"),oo=d("Extraction Blacklist"),ot=d("Reset Extraction Blacklist"),ox=d("ExtrCustom"),oy=d("ExtrCustomMatchs"),oB=d("ML extractions"),oF=d("ML extractions custom matches"),o8=[0,d(a2),708,13],pj=[2,1],pk=[0,d(a2),1163,9],pm=[0,1],po=[0,1],pp=[0,1],pu=[0,d(a2),1507,48],pi=[0,d(a2),1045,10],pg=[0,[11,d("program_branch_"),[4,0,0,0,[10,0]]],d("program_branch_%d%!")],o6=[0,d(a2),699,13],o4=[0,d(a2),637,22],o0=[0,d(a2),353,18],oZ=[0,d(a2),354,11],o1=[5,1],oY=[0,1],oR=[0,d(a2),169,4],oJ=d("Extraction_plugin.Mlutil.Found"),oK=d("Extraction_plugin.Mlutil.Impossible"),oL=d("x"),oM=d(bp),ps=d("Extraction_plugin.Mlutil.Toplevel"),pw=[0,d("Coq.Init.Wf.well_founded_induction_type"),[0,d("Coq.Init.Wf.well_founded_induction"),[0,d("Coq.Init.Wf.Acc_iter"),[0,d("Coq.Init.Wf.Fix_F"),[0,d("Coq.Init.Wf.Fix"),[0,d("Coq.Init.Datatypes.andb"),[0,d("Coq.Init.Datatypes.orb"),[0,d("Coq.Init.Logic.eq_rec_r"),[0,d("Coq.Init.Logic.eq_rect_r"),[0,d("Coq.Init.Specif.proj1_sig"),0]]]]]]]]]],pH=d(aj),pI=[0,d(ak),gL,10],qu=d(gM),qv=d(gM),qs=[0,d(ak),647,11],qt=[0,d(ak),649,49],qr=d("char"),qq=d("Prelude.Char"),qm=[0,d(ak),589,2],qk=d(bp),qj=d(av),ql=[0,d(ak),579,10],qi=[0,d(ak),550,10],qh=[0,d(ak),532,2],qg=[0,d(ak),kA,10],qf=[0,d(ak),519,5],qd=[0,d(aj),0],qc=d(aj),p_=[0,d(aj),0],p7=[0,d(ak),380,6],p6=[0,d(ak),381,6],p8=d(U),p9=d(aj),p3=d(aj),p4=d(bp),p5=d("Coq"),p2=d(gz),pZ=d(gz),p0=d("coq_"),pY=d("Coq__"),pW=[0,d(ak),295,53],pV=[0,d(ak),283,14],pU=d("get_mpfiles_content"),pL=[0,d(ak),118,2],pM=d(gz),pG=d(W),pF=d(cg),pE=d(cg),pD=d(cg),pB=d(W),pC=d(W),pz=d(c8),pA=d(ez),pJ=d(av),pK=d(U),qn=d("ascii"),qo=d("Coq.Strings.Ascii"),qL=d('error "AXIOM TO BE REALIZED"'),qM=d(gQ),qP=[0,d(ew),93,8],qN=d("`"),qO=d("delay "),qQ=d("Cannot handle tuples in Scheme yet."),qT=d("Cannot handle general patterns in Scheme yet."),qR=d(lb),qS=d(k1),qU=d(lg),qV=d(U),qW=d(kI),qX=d(cg),qY=[0,d(ew),146,11],qZ=d(W),q0=d(c8),q1=d(c8),q2=d("(("),q3=d("letrec "),q7=[0,d(ew),215,29],q6=d(eE),q5=d(kw),q4=d(kw),qK=d("@ "),qH=d("lambdas "),qI=d("lambda "),qJ=[0,d(ew),50,10],qC=d("(define __ (lambda (_) __))\n\n"),qD=d('(load "macros_extr.scm")\n\n'),qE=d(";; available at http://www.pps.univ-paris-diderot.fr/~letouzey/scheme\n"),qF=d(";; This extracted scheme code relies on some additional macros\n"),qA=d(";; "),qx=c3([d("define"),d(gB),d("lambda"),d("lambdas"),d(kT),d("apply"),d("car"),d("cdr"),d(lg),d("delay"),d(lb),d(bp),d(U)]),q$=d(".scm"),ra=[0,d(c9),30,18],rc=[0,d(c9),211,9],rk=[9,d(eE)],rg=[0,d(c9),316,9],re=[0,d(c9),235,29],rf=[0,d(c9),231,14],rd=d("reference not found in extracted structure."),rb=d("Extraction_plugin.Modutil.Found"),rl=d("Extraction_plugin.Modutil.RemainingImplicit"),rW=d('failwith "AXIOM TO BE REALIZED"'),rX=d(U),rZ=[0,d(c4),250,8],rY=d("lazy "),r0=[0,d(c4),kW,8],r1=d(k4),r2=d("Lazy.force"),r3=d(kn),r4=d(k1),r5=d(gE),r6=d(gN),r7=d("assert false"),r8=d(aj),sa=d(U),r9=d(gE),r_=d(gN),r$=d(U),sb=d(kB),se=[0,d(c4),kH,8],sc=d(c8),sd=d(ez),sf=d(av),sg=d(kB),sj=d(eq),si=d(ai),sh=d(la),sk=d("{ "),sl=d(bp),sm=d(eu),sn=d(ev),so=d("else "),sp=d("then "),sq=d("if "),sr=d(eF),ss=d(gV),sx=d(" = function"),sv=d(kn),sw=d(" = match "),st=d(a3),su=d(ai),sz=d(eo),sy=d(gJ),sA=d(kM),tl=d(k_),tm=d("include module type of struct include "),tn=d(c6),to=d(" : sig"),tp=d(bJ),tq=d(k_),tr=d("module type of struct include "),ts=d(eB),tt=d(bJ),tu=d(eB),tv=d(bJ),tw=d(ap),tx=d(ex),ty=d(ai),tz=d(ex),tA=d(k6),tB=d(kN),tC=d(kK),tD=d(c6),tF=d(W),tE=d(en),tG=d(" with type "),tH=d(ap),tI=d(" with module "),tJ=d(ap),tK=d("include "),tL=d(c6),tM=d(" = struct"),tN=d(bJ),tO=d(kZ),tP=d(ap),tQ=d(bJ),tR=d(ai),tS=d(bJ),tT=d(ap),tU=d(ex),tV=d(ai),tW=d(ex),tX=d(k6),tY=d(kN),tZ=d(kK),t0=d(c6),t2=d(W),t1=d(ks),t3=d(c8),t4=d(ez),ti=d(ai),th=d(le),tf=d(ai),tg=d(bm),tj=d(eB),tk=d("val "),tc=d(ai),s$=d(le),tb=d(ai),ta=d(bm),td=d(ap),te=d(gQ),s7=d(U),s_=d(aj),s8=d(bm),s9=d(eo),s3=d(eo),s4=d(" Lazy.t"),s5=d(U),s6=d(ap),s0=d(eq),sZ=d(" : "),sY=d(la),s1=d(" = { "),s2=d(bm),sV=d(k8),sW=d(ai),sX=d(bm),sT=d(kR),sU=d(kX),sO=d("* "),sQ=d(" of "),sP=d(gV),sR=d(" unit (* empty inductive *)"),sS=d(ai),sL=d(ap),sM=d(av),sN=d(ap),sK=d(eE),sH=d(ap),sI=d(kM),sJ=d(eo),sD=d(" **)"),sE=d(eB),sF=d("(** val "),sB=[0,0,0],sC=[0,0,-100000],rR=d(eu),rS=d(ev),rK=d(U),rM=d(kv),rN=d(en),rO=d(k2),rP=d("'a"),rQ=d(U),rL=[0,d(c4),163,36],rJ=d(U),rI=[0,d(c4),148,9],rC=d("let __ = let rec f _ = Obj.repr f in Obj.repr f"),rB=d("type __ = Obj.t"),rz=d(gE),rA=d(gN),ry=d("open "),rs=d(ai),rt=d(gQ),ru=d(es),rq=d(W),rp=d(eF),rr=d("fun "),rn=d(gM),rw=c3([d("and"),d(kL),d("assert"),d("begin"),d(kq),d("constraint"),d(ld),d("done"),d("downto"),d(kU),d(c6),d("exception"),d("external"),d(ev),d(kr),d("fun"),d("function"),d("functor"),d(k0),d(es),d("include"),d("inherit"),d("initializer"),d("lazy"),d(gB),d(kT),d("method"),d(gT),d("mutable"),d("new"),d("object"),d(lf),d("open"),d("or"),d("parser"),d("private"),d("rec"),d(en),d(ks),d(k$),d("to"),d(eu),d("try"),d(eC),d("val"),d("virtual"),d("when"),d("while"),d("with"),d("mod"),d("land"),d("lor"),d("lxor"),d("lsl"),d("lsr"),d("asr"),d(ku),d(bp),d(U)]),rF=c3([61,60,62,64,94,59,38,43,45,42,47,36,37]),rG=c3([33,36,37,38,42,43,45,46,47,58,60,61,62,63,64,94,124,gR]),rH=[0,d("::"),[0,d(cg),0]],t6=[0,d(".mli")],t7=d(gP),us=d("type:unknown"),ut=d(u),uu=d("type:axiom"),uv=d(u),uw=d("right"),ux=d("left"),uy=d("type:arrow"),uz=d(u),uA=d(gG),uB=d(X),uC=d("type:glob"),uD=d(u),uH=d(X),uI=d("type:var"),uJ=d(u),uE=d(X),uF=d("type:varidx"),uG=d(u),uL=d("type:dummy"),uM=d(u),uK=[0,d(kF),67,25],vi=d(da),vj=d(X),vk=d("fix:item"),vl=d(u),uN=d("expr:axiom"),uO=d(u),uP=d(X),uQ=d("expr:rel"),uR=d(u),uS=d(gG),uT=d("func"),uU=d("expr:apply"),uV=d(u),uW=d(da),uX=d(c5),uY=d(k7),uZ=d(u),u0=d(da),u1=d("nameval"),u2=d(X),u3=d("expr:let"),u4=d(u),u5=d(X),u6=d("expr:global"),u7=d(u),u8=d(gG),u9=d(X),u_=d("expr:constructor"),u$=d(u),va=d(kE),vb=d("expr:tuple"),vc=d(u),vd=d("cases"),ve=d("expr"),vf=d("expr:case"),vg=d(u),vh=d(kr),vm=d("funcs"),vn=d("expr:fix"),vo=d(u),vp=d("msg"),vq=d("expr:exception"),vr=d(u),vs=d("expr:dummy"),vt=d(u),vu=d(eA),vv=d("expr:coerce"),vw=d(u),vx=d("int"),vy=d("expr:int"),vz=d(u),vA=d(da),vB=d("pat"),vC=d(kC),vD=d(u),vE=d("pat:wild"),vF=d(u),vG=d(kE),vH=d("pat:tuple"),vI=d(u),vJ=d(X),vK=d("pat:rel"),vL=d(u),vM=d(c5),vN=d(X),vO=d("pat:constructor"),vP=d(u),vQ=d(da),vR=d(c5),vS=d(k7),vT=d(u),wi=[0,d(kF),254,29],wk=d(db),wl=d("  ]"),wm=d("    "),wn=d(": ["),wo=d("declarations"),wp=d(a3),wq=d(cg),wa=d(eA),wb=d(eC),wc=d(X),wd=d("fixgroup:item"),we=d(u),v1=d(aj),v2=d(eA),v3=d(c5),v4=d(X),v5=d("decl:type"),v6=d(u),v7=d(eA),v8=d(eC),v9=d(X),v_=d("decl:term"),v$=d(u),wf=d("fixlist"),wg=d("decl:fixgroup"),wh=d(u),vU=d("argtypes"),vV=d(X),vW=d("constructors"),vX=d(c5),vY=d(X),vZ=d("decl:ind"),v0=d(u),uk=d("used_modules"),ul=d("need_dummy"),um=d("need_magic"),un=d(X),uo=d(gT),up=d(u),uq=d(" */"),ur=d("/* "),ug=d(et),uh=d(a3),ui=d(ey),ud=d(et),ue=d(a3),uf=d(ey),uc=d(db),ua=d(a3),ub=d("{"),t$=d(kZ),t8=d(eu),t9=d(ev),wt=d(".json"),w6=d(lc),w7=d("() -- AXIOM TO BE REALIZED"),w8=d(kv),w9=d(en),w_=d(k2),w$=d("a"),xb=d("()"),xa=[0,d(er),eD,27],xc=d('Prelude.error "AXIOM TO BE REALIZED"'),xd=d(U),xe=d(db),xf=d(ap),xg=d(kp),xh=d(es),xi=[0,d(er),172,8],xj=[0,d(er),183,8],xk=d(k4),xl=d(" of {"),xm=d("case "),xn=d("Prelude.error"),xo=d(aj),xq=d(U),xp=d(U),xr=d(kQ),xs=d(kI),xt=d(bp),xu=d(eF),xv=d(W),xw=d(db),xx=d(eq),xA=d(eq),xy=d(gJ),xz=d(db),xB=d(kp),xC=d(a3),xD=d(ai),x6=[0,d(er),377,29],x5=d(eE),x3=d(ap),x4=d(kz),xW=d(W),x0=d(W),xZ=d(gA),xV=d("= () -- AXIOM TO BE REALIZED"),xY=d(gA),xX=d(bm),x1=d(ap),x2=d(kz),xP=d(W),xS=d(gV),xL=d(W),xM=d(W),xN=d(" () -- empty inductive"),xT=d(a3),xU=d(W),xO=d(ai),xQ=d(bm),xR=d("data "),xH=d(k8),xI=d(gA),xK=d(W),xJ=d(bm),xE=d(kR),xF=d(kX),w4=d(W),w3=d(eF),w5=d("\\"),wB=d("import qualified "),wC=d('__ = Prelude.error "Logical or arity value used"'),wD=d("__ :: any"),wE=d(gF),wF=d("type Any = ()"),wG=d(gU),wH=d(gW),wI=d("type Any = GHC.Base.Any"),wJ=d(gK),wK=d(gF),wL=d("unsafeCoerce = IOExts.unsafeCoerce"),wM=d(kD),wN=d(gU),wO=d(gW),wP=d("unsafeCoerce = GHC.Base.unsafeCoerce#"),wQ=d(kD),wR=d(gK),wS=d(gF),wT=d("import qualified IOExts"),wU=d(gU),wV=d(gW),wW=d("import qualified GHC.Base"),wX=d(gK),wY=d("import qualified Prelude"),wZ=d(" where"),w0=d(bJ),w1=d('{- For Hugs, use the option -F"cpp -P -traditional" -}'),w2=d("{-# OPTIONS_GHC -cpp -XMagicHash #-}"),wy=d(" -}"),wz=d("{- "),wx=d("-- "),wv=c3([d(lc),d(kC),d(kq),d("data"),d("default"),d("deriving"),d(ld),d(kU),d(k0),d("import"),d(es),d("infix"),d("infixl"),d("infixr"),d("instance"),d(gB),d(gT),d("newtype"),d(lf),d(k$),d(eC),d("where"),d(bp),d(U),d(kL),d("qualified"),d("hiding"),d(ku),d(kQ)]),x_=d(".hs"),yd=[0,1],yf=[0,0,0],yg=[0,1],yi=[5,1],yk=[0,d(N),355,48],yj=[0,d(N),351,27],yl=[0,d(N),kH,26],ym=[5,0],yo=[0,d(N),kW,8],yn=[5,0],yp=[0,d(N),269,19],yr=[0,d(N),kA,17],ys=[0,d(N),508,8],yw=[0,d(N),694,33],yx=[0,d(N),693,15],yy=[0,d(N),724,11],yz=[0,[10,1],0],yA=[0,d(N),820,15],yB=[0,d(N),805,2],yE=[5,1],yD=[0,1],yI=[0,d(N),847,2],yC=[9,d("absurd case")],yF=[0,d(N),860,8],yH=[0,d(N),892,10],yG=[0,d(N),894,10],yV=[0,[10,1],[5,1]],yU=[0,[10,0],[5,0]],yT=[5,1],yS=[0,[5,0]],yQ=[5,1],yR=[10,1],yP=[5,0],yN=[0,d(N),1069,85],yO=[0,d(N),1065,12],yM=[0,d(N),1058,32],yJ=[5,1],yK=[10,1],x$=d("Extraction_plugin.Extraction.I"),yb=d("Extraction_plugin.Extraction.NotDefault"),y6=[0,d(bl),273,15],y8=[0,d(bl),352,16],y9=[0,d(bl),410,6],zd=[0,0,0],zK=d("No ongoing proof"),zH=[0,1],zz=d("This command only works with OCaml extraction"),zA=d(gP),zB=d("testextraction"),zC=d(lh),zD=d(gP),zE=d(".cmo"),zF=d(".cmi"),zG=d("Extracted code successfully compiled"),zr=d(lh),zs=d("-c"),zt=d("-I"),zu=d("ocamlc"),zx=d(" failed with exit code "),zy=d(k5),zp=d(" failed with error "),zq=d(k5),zn=[0,1],zl=[0,d(bl),704,32],zk=[0,d(bl),690,11],zj=[0,0,0],zi=d("(** User defined extraction *)"),zh=[0,d(bl),663,9],ze=[0,d(bl),639,11],zc=d("[ \t\n]+"),za=d("Extraction: provided filename is not a valid identifier"),y3=[0,d(bl),c7,18],yW=d("CONSTANT"),yX=d("INCLUDE"),yY=d("INDUCTIVE"),yZ=d("MODULE"),y0=d("MODULE TYPE"),y1=d("No extraction of toplevel Include yet."),y4=d("Extraction_plugin.Extract_env.Impossible"),y_=d("Main"),Ah=d('The spelling "OCaml" should be used instead of "Ocaml".'),Ac=d(kS),Ad=d(kJ),Ae=d(k9),Af=d(kx),zZ=d("mlname"),Aa=d("int_or_id"),Ai=d("deprecated"),Aj=d("deprecated-ocaml-spelling"),Am=d("Ocaml"),Ap=d(kS),As=d(kJ),Av=d(k9),Ay=d(kx),AB=d("language"),AG=d("TestCompile"),AH=d(C),AM=d(C),AQ=d(C),AR=d(kP),AV=d(C),AZ=d(C),A3=d(C),A4=d("Separate"),A8=d("SeparateExtraction"),Ba=d(ko),Bb=d(C),Bf=d("ExtractionLibrary"),Bj=d(ko),Bk=d(C),Bl=d(kP),Bp=d("RecursiveExtractionLibrary"),Bt=d("Language"),Bu=d(C),By=d("ExtractionLanguage"),BC=d(gD),BD=d(C),BH=d("ExtractionInline"),BL=d("NoInline"),BM=d(C),BQ=d("ExtractionNoInline"),BT=[0,d(k3),[0,d(C),[0,d(gD),0]]],BX=d("PrintExtractionInline"),B0=[0,d(kV),[0,d(C),[0,d(gD),0]]],B4=d("ResetExtractionInline"),B8=[0,d(et),0],B9=d(ey),B$=d("Implicit"),Ca=d(C),Ce=d("ExtractionImplicit"),Ci=d(gC),Cj=d(C),Cn=d("ExtractionBlacklist"),Cq=[0,d(k3),[0,d(C),[0,d(gC),0]]],Cu=d("PrintExtractionBlacklist"),Cx=[0,d(kV),[0,d(C),[0,d(gC),0]]],CB=d("ResetExtractionBlacklist"),CF=d(gO),CI=d(kG),CJ=d(gI),CN=d("ExtractionConstant"),CR=d(gO),CT=d(kG),CU=d("Inlined"),CV=d(gI),CZ=d("ExtractionInlinedConstant"),C3=d(et),C5=d(ey),C7=d(gO),C9=d("Inductive"),C_=d(gI),Dc=d("ExtractionInductive"),Df=[0,d("Show"),[0,d(C),0]],Dj=d("ShowExtraction");function
...
dv=[bo,oJ,bk(0)],q=[bo,oK,bk(0)],a7=c(f[1][6],oL),bT=c(f[1][6],oM),h0=[0,a7];function
bv(b){if(b){var
...
p=h-c(e[17][1],m)|0,f=a(j[6],0,p),q=function(a){return i(d,a)},r=a(e[17][68],q,m),s=function(a){return x(f,a)},t=a(e[17][68],s,r),u=cA(f),v=dI(k,a(e[18],t,u)),w=[1,x(f,n),v];return ac(a(e[17][eD],f,g),w)}}if(l(d,b)){var
...
O=a(j[6],0,d-b|0),A=a(e[17][kO],O,s),B=a(e[17][68],ar,A),C=ar(0),p=bx([0,z,a8([0,B,C])]),n=bx([0,C,F]),q=function(d){if(0===o[1])return aI(p,c(e[17][5],d));var
b=cw(z)[2];if(typeof
...
r=(b+l|0)-d|0,E=a(e[17][kO],r,f),R=cB(r,E),S=function(a){return x(r,a)},T=a(e[17][68],S,D);return aI(n,bW(q(a(e[18],T,R)),E))}throw[0,m,yB]}function
yu(d,p,E,D,b,h){var
...
m=a(e[17][68],l,k),f=a(n[92],c,h),b=d-j|0,o=f[2],p=f[1],q=a(e[17][eD],b,m),s=a(e[18],q,p),t=a(e[17][53],1,b),u=a(e[17][14],n[10],t);return[0,s,cM(a(n[au][1],b,o),u)]}function
...
f=0;if(!f)var
l=C,F=B;var
G=c(e[17][1],l),H=a(e[17][eD],G,k),I=a(e[17][bq],G,A),X=I[1],Y=a8([0,I[2],S]),Z=g(e[17][15],aK[5],aK[1],X);function
